...
if [[ ! -f "cmake-3.23.1-linux-x86_64.sh" ]]; then
    wget https://github.com/Kitware/CMake/releases/download/v3.23.1/cmake-3.23.1-linux-x86_64.sh -O cmake-3.23.1-linux-x86_64.sh
fi
chmod +x cmake-3.23.1-linux-x86_64.sh
./cmake-3.23.1-linux-x86_64.sh --skip-license --prefix=/usr

if [[ ! -f "ninja-1.11.0.tar.gz" ]]; then
    wget https://github.com/ninja-build/ninja/archive/refs/tags/v1.11.0.tar.gz -O ninja-1.11.0.tar.gz
fi
rm -rf ninja-1.11.0
